...
const Modal = () => {
  ...
  return Id ? (
    <>
      <div className="fixed top-0 left-0 right-0 bottom-0 w-full h-screen bg-[#000000] opacity-50 z-50"></div>
      <div className="w-[90%] sm:w-[400px] text-black mx-auto pb-[30px] shadow-lg fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white z-[9999999] rounded-lg">
        <div>
          {pokemon.map((pok) => (
